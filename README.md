...
But don’t get to ahead of yourself and pack your bags yet. You need to take a step back and plan for your big city vacation adventure.<br/><br/>
...
But that is not all, we would like to provide additional resources to get the most out of your vacation by creating a layered map. <br/>
...
<li>	Machine Learning model to train and predict the maximum temperature, dependent variable, utilizing our independent variables like sunlight hours, air frost days, minimum temperature, precipitation, and snowfall. We will create this trained model to have suggestions ready upon user input that will be provided by the interactive dashboard created as described below.</li> <br/> 
